...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'short_text', type: 'string', description: 'Краткий текст (Markdown)', nullable: true, example: 'Краткий текст'),
        new OA\Property(property: 'full_text', type: 'string', description: 'Полный текст контента (Markdown)', nullable: true, example: '### Заголовок\n\nПолный текст контента'),
