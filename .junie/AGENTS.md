...
- создай обязательный файл `docs/ui.md` - здесь перечисли компоненты UI которые используются в системе, где и как используются
- использование FSD
...
# Тестирование
- Не допускай перезаписывание всех данных в базе, при тестах или любой другой отладке
